                      ...
                      <>
                        ...
                        prop.permission.is_deposit_bonus_claim_active == "1" ? (
                          <Grid container spacing={3}>
                                        ...
                                        <div>
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              {/* <li className={`bounsBox mar-10 `}>
                                    <img
                                      src="https://admin.Berry Markets.com/uploads/bonus_offer_image/bonus_offer_1673360159_50.png"
                                      alt="50%"
                                      style={{
                                        width: "100%",
                                        borderRadius: "10px",
                            ...
                            <div className="w-100">
                              <img
                                src="./Unity IT hub_login_files/bonus30.png"
                                className="w-100"
                                alt="Bonus 50%"
                              />
                            </div>
                        ...
                        >
                          <div style={{padding:"10px"}}>
                              <div className="text-align-center">
                                <img width="220px"  src={`${prop.SITE_URL}uploads/images/deposit_kyc_image.png`} alt="" />
                              </div>
